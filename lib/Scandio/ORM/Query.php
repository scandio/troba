...
/**
 * A OO wrapper with chaining for ORM::query
 */
class Query
{
    /**
    ...
    {
        $this->joins[] = ORM::join(ORM::INNER_JOIN, $entity, $query);
        return $this;
    }
    ...
    {
        $this->joins[] = ORM::join(ORM::LEFT_JOIN, $entity, $query);
        return $this;
    }
    ...
    {
        $this->joins[] = ORM::join(ORM::RIGHT_JOIN, $entity, $query);
        return $this;
    }
